...
- ดาวน์โหลดเป็นไฟล์ PDF ผ่านเซิร์ฟเวอร์คุณภาพสูง (Chromium Print to PDF)
...
## การใช้งาน PDF คุณภาพสูง (Chromium Print to PDF)

1. ติดตั้ง dependency: `npm install --omit=dev`
2. ติดตั้ง Chromium ผ่าน Playwright: `npx playwright install --with-deps`
3. รันเซิร์ฟเวอร์: `npm run start`
4. เปิดหน้าเว็บผ่าน `http://localhost:3000` แล้วกด **ดาวน์โหลดเป็น PDF (คุณภาพสูง: Chromium)**
...
> หากระบบยังไม่พบ Chromium ผ่าน Playwright ปุ่มดาวน์โหลดคุณภาพสูงจะถูกปิดพร้อมข้อความแจ้งเตือนอัตโนมัติ
