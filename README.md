...
## Railway + PrinceXML (ต้องใช้ Docker)

Railway ไม่รองรับการติดตั้ง PrinceXML แบบที่ต้องใช้แพ็กเกจระบบใน runtime ปกติ จึงต้องใช้โหมด Docker

1. เปิดโปรเจกต์บน Railway แล้วเลือก **Deploy from Dockerfile**
2. ใช้ไฟล์ `Dockerfile` ที่เตรียมไว้ใน repo นี้ (ติดตั้ง PrinceXML + Node runtime)
3. ตั้งค่า **Port** เป็น `3000`
4. Deploy แล้วเข้าใช้งานผ่าน URL ที่ Railway ให้มา

> หมายเหตุ: PrinceXML เป็นซอฟต์แวร์มีลิขสิทธิ์ หากต้องใช้งานจริงใน production ควรจัดการ License ตามเงื่อนไขของ PrinceXML
